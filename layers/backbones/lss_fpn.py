...
class DepthNet(nn.Module):
    def __init__(self, in_channels, mid_channels, context_channels,
        ...
        self.depth_se = nn.Identity() # SELayer(mid_channels)  # NOTE: add camera-aware
    ...
    def forward(self, x, mats_dict):
        ...
        # pad = torch.zeros((depth.shape[0], 80, depth.shape[2], depth.shape[3]), device=depth.device)
...
class LSSFPN(nn.Module):
    ...
    def get_geometry(self, sensor2ego_mat, intrin_mat, bda_mat):
